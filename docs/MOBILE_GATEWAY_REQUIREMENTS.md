...
> Last updated: 2026-06-14 | Android version: v1.17.0-rc22 | Protocol: mobile-gateway.v1
...
Implemented through v1.17.0-rc22:
...
- Android share-sheet `text/plain` content can be imported into Ask WillDeep and then sent to the Mac gateway.
...
Gateway events parsed by Android v1.17.0-rc22:
...
- Version `1.17.0-rc22` is visible in Gradle metadata and sent through gateway request headers.
