...
> Last updated: 2026-06-14 | Current version: v1.15.0-rc2
...
- Check Mac gateway health from either a pairing payload or the saved paired Mac, then display server version plus pairing availability.
